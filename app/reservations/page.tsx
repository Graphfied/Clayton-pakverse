...
import ReservationsComponents from "./_components/ReservationsComponents";
import { currentUser } from "@/lib/currentUser";
import { GetCompletedReservations } from "@/actions/reservation";

const ReservationsPage = async () => {
  const user: any = await currentUser();
  const reservations: any = await GetCompletedReservations(user?.id);
  return (
    <div className=" text-white">
      ...
      {/* Reservations */}
      <ReservationsComponents reservations={reservations} />
    </div>
  );
};
